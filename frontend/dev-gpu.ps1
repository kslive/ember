# GPU-accelerated development script for Ember (Windows PowerShell)
# Automatically detects and runs in development mode with optimal GPU features

Write-Host "GPU-Accelerated Development Mode for Ember" -ForegroundColor Blue
Write-Host ""
...
Write-Host ""
Write-Host "Starting Ember in development mode..." -ForegroundColor Blue
Write-Host ""
