// Vendored verbatim from sherpa-onnx swift-api-examples (Apache-2.0, Xiaomi Corp)
// via willwade/sherpa-onnx-spm. The SPM package's own copy is INTERNAL to its
// module (zero public symbols), so the app can't call it — this copy lives in
// OUR module instead. Only the import line is changed (the package re-exports
// the C module). Excluded from swiftformat/swiftlint.
